    ...
    <div class="col-12 col-xl-6">
        <div class="card card-h-100">
            <div class="card-header">
                <h5 class="card-title mb-0">Teacher Availability</h5>
            </div>
            <div class="card-body">
                <p class="text mb-4">Set the days and time windows each teacher is available. Teachers with no entries are assumed available the full day (7:30 AM – 7:00 PM, Mon–Sat).</p>
                <div class="row g-3">
                    <div class="col-md-6">
